...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'constants.ROLE_ADMIN' => 'integer',
            'constants.ROLE_USER' => 'integer',
            'constants.STATUS_ATTENDANCE' => 'integer',
            'constants.STATUS_WORKING' => 'integer',
            'constants.STATUS_BREAK' => 'integer',
            'constants.STATUS_LEAVING' => 'integer',
            'constants.STATUS_PENDING' => 'integer',
            'constants.STATUS_APPROVED' => 'integer',
            'cors.paths' => 'string',
...
'cache.stores.apc.driver','cache.prefix','constants.ROLE_ADMIN','constants.ROLE_USER','constants.STATUS_ATTENDANCE',
'constants.STATUS_WORKING','constants.STATUS_BREAK','constants.STATUS_LEAVING','constants.STATUS_PENDING','constants.STATUS_APPROVED',
...
'filesystems.links./var/www/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'verified','role','route.role',);
        registerArgumentsSet('routes', 
'dusk.login','dusk.logout','dusk.user','login',
...
'two-factor.confirm','two-factor.disable','two-factor.qr-code','two-factor.secret-key','two-factor.recovery-codes','sanctum.csrf-cookie','admin.login','logout','admin.attendance.list','admin.staff.list','admin.attendance.staff',
'admin.attendance.staff.export','stamp_correction_request.approve.show','stamp_correction_request.approve','attendance','attendance',
'attendance','attendance.list','attendance.show','attendance.stamp_correction_request','stamp_correction_request.list',);
        registerArgumentsSet('views', 
'admin.applications.approve','admin.applications.index','admin.attendance.index','admin.attendance.show','admin.staff.attendance.index',
'admin.staff.index','applications.index','attendance.index','attendance.register','attendance.show',
'auth.admin.login','auth.login','auth.register','emails.login','layouts.app',
'layouts.link','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'validation.custom.attribute-name.rule-name','validation-inline.accepted','validation-inline.active_url','validation-inline.after','validation-inline.after_or_equal',
'validation-inline.alpha','validation-inline.alpha_dash','validation-inline.alpha_num','validation-inline.array','validation-inline.before',
'validation-inline.before_or_equal','validation-inline.between.numeric','validation-inline.between.file','validation-inline.between.string','validation-inline.between.array',
'validation-inline.boolean','validation-inline.confirmed','validation-inline.date','validation-inline.date_equals','validation-inline.date_format',
'validation-inline.different','validation-inline.digits','validation-inline.digits_between','validation-inline.dimensions','validation-inline.distinct',
'validation-inline.email','validation-inline.ends_with','validation-inline.exists','validation-inline.file','validation-inline.filled',
'validation-inline.gt.numeric','validation-inline.gt.file','validation-inline.gt.string','validation-inline.gt.array','validation-inline.gte.numeric',
'validation-inline.gte.file','validation-inline.gte.string','validation-inline.gte.array','validation-inline.image','validation-inline.in',
'validation-inline.in_array','validation-inline.integer','validation-inline.ip','validation-inline.ipv4','validation-inline.ipv6',
'validation-inline.json','validation-inline.lt.numeric','validation-inline.lt.file','validation-inline.lt.string','validation-inline.lt.array',
'validation-inline.lte.numeric','validation-inline.lte.file','validation-inline.lte.string','validation-inline.lte.array','validation-inline.max.numeric',
'validation-inline.max.file','validation-inline.max.string','validation-inline.max.array','validation-inline.mimes','validation-inline.mimetypes',
'validation-inline.min.numeric','validation-inline.min.file','validation-inline.min.string','validation-inline.min.array','validation-inline.multiple_of',
'validation-inline.not_in','validation-inline.not_regex','validation-inline.numeric','validation-inline.password','validation-inline.present',
'validation-inline.regex','validation-inline.required','validation-inline.required_if','validation-inline.required_unless','validation-inline.required_with',
'validation-inline.required_with_all','validation-inline.required_without','validation-inline.required_without_all','validation-inline.same','validation-inline.size.numeric',
'validation-inline.size.file','validation-inline.size.string','validation-inline.size.array','validation-inline.starts_with','validation-inline.string',
'validation-inline.timezone','validation-inline.unique','validation-inline.uploaded','validation-inline.url','validation-inline.uuid',
'validation-inline.custom.attribute-name.rule-name',);
...
'PUSHER_APP_CLUSTER','MIX_PUSHER_APP_KEY','MIX_PUSHER_APP_CLUSTER','DUSK_CHROMEDRIVER_VERSION',);
